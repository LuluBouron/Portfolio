const id = "maestra.md";
						...
						const data = {title:"Maestra",description:"Application web qui répértorie les différents moyens de contraception\n",publishDate:new Date(1677715200000),tags:["Symfony","React","Back-Office"],img:"/assets/maestra.png",img_alt:"Maestra landing page"};
						const _internal = {
							type: 'content',
							filePath: "/home/parallels/Portfolio/src/content/work/maestra.md",
							rawData: undefined,
						};
