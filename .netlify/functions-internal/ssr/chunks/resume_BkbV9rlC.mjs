...
const html = "<h2 id=\"présentation-du-projet\">Présentation du projet</h2>\n<p><em>Resume</em> est une une version “web” de mon CV, en utilisant le standard JsonResume,\nafin de rendre un CV facilement modifiable et maintenable.</p>\n<h3 id=\"stack\">Stack</h3>\n<ul>\n<li>Symfony</li>\n<li>Tailwind CSS</li>\n<li>HyperUI / AlpineJS</li>\n</ul>";
				...
				const frontmatter = {"title":"Web Resume","publishDate":"2024-02-19T00:00:00.000Z","img":"/assets/cv.png","img_alt":"Resume Landing Page.","description":"Création d'une version \"web\" de mon CV, en utilisant le standard JsonResume.\n","tags":["Symfony","JSON","Tailwind CSS"]};
